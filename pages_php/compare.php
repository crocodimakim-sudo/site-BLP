...
// 2026-05-04: title сокращён с 84 до 51 симв., серии перечислены в description (Phase 3)
$page_title    = 'Сравнение 4 серий фиброцементных панелей BLP Board';
            ...
            <div class="blp-hero-content">
                ...
                <ul class="blp-hero-list">
                    <li class="blp-hero-list-item">
                        ...
                        <!-- 2026-08-18: сверка с эталоном — ГОСТ 8747-88 (асбестоцементные волнистые листы) не относится к продукции, заменён на ГОСТ 18124-2012 -->
                        <span>Все серии: НГ (К0), без асбеста, ГОСТ 18124-2012</span>
                    </li>
                    <li class="blp-hero-list-item">
                        <span class="blp-hero-check"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12"></polyline></svg></span>
        ...
        <div class="compare-table-wrap">
            <table class="compare-matrix-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <?php /* 2026-09-13: масса по канону веса — толщина × вес на м².
                             NATURE 8/10/12 → 13–19,8; POLISHED 8/10/12/15 → 13–24,8;
                             TEXTURE 10/12 → 16,5–19,8. WALYPAN — профиль, данных в базе нет, не трогаем. */ ?>
                    ...
                    <!-- 2026-08-18: сверка с эталоном — морозостойкость 100+ занижена, по ТС 7515-26 (табл. 2) ≥150 циклов (F150) -->
                    <tr>
