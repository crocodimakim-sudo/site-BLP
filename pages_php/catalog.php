...
<div class="catalog-intro-header">
    ...
    <!-- 2026-05-07: дисклеймер цен — ст. 437 ГК РФ, в зоне видимости пользователя над ценами -->
    <p class="catalog-price-disclaimer" style="margin-top:16px;padding:12px 16px;background:#f8f9fa;border-left:3px solid #00352F;border-radius:6px;font-size:13px;line-height:1.5;color:#5a5a5a;">
        Цены указаны за 1&nbsp;м² и носят <strong>информационный характер</strong>. Не являются публичной офертой (ст.&nbsp;437 ГК&nbsp;РФ). Финальная стоимость зависит от объёма, толщины, серии и условий поставки и подтверждается в счёте на оплату. Подробнее — в <a href="/policy" style="color:#00352F;">Политике конфиденциальности</a> (п.&nbsp;14).
    </p>
</div>
