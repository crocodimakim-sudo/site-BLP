...
$faq_schema = [
    ...
    'mainEntity' => [
        ...
        [
            ...
            'acceptedAnswer' => [
                '@type' => 'Answer',
                'text' => 'Гарантийный срок — 5 лет. Расчётный срок службы фиброцемента — 50+ лет при соблюдении условий монтажа. Материал устойчив к морозному расклиниванию (выдерживает 100+ циклов замораживания/оттаивания), ультрафиолетовому излучению и атмосферным осадкам. Цвет сохраняется весь срок службы: краситель вводится в массу при производстве, а не наносится сверху.'
            ]
        ],
    ]
];
    ...
    <div class="blp-container">
        ...
        <div class="faq-accordion">
            ...
            <div class="faq-item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
                ...
                <div class="faq-answer" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                    <div itemprop="text">
                        <p>Гарантийный срок — <strong>5 лет</strong>. Расчётный срок службы фиброцемента — 50+ лет при соблюдении условий монтажа.</p>
