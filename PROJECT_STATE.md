...
| **Локальный путь** | `D:\Claude Code\02-building-port\01-sites-buildingport\01-site-blpboard` |
...
- **Файл:** `D:\Claude Code\02-building-port\01-sites-buildingport\01-site-blpboard-hosting.zip`
- **Размер:** ~188 MB
