...
- [ ] **13. Активировать /faq и /install (2026-08-18)** — страницы выключены в админке (`is_live=false`), контент сверен с эталоном нового производителя и задеплоен 2026-08-18; при активации вернуть оба URL в `sitemap.xml`. → готово когда: обе страницы отдают 200 и возвращены в sitemap.
- [ ] **14. Контент-план на основе сверенных данных (2026-08-18)** — эталон ТС 7515-26 + АТР + К0 на 10 НФС; составить план SEO-статей и постов Telegram. Источники: `../../02-фиброцемент-база/10-SEO-И-ПРОДВИЖЕНИЕ/07-контент-план/план.md` и `../../02-фиброцемент-база/09-ИСТОЧНИКИ-И-ИСХОДНИКИ/Новый производитель/ЭТАЛОН-факты.md`. → готово когда: план-файл создан и утверждён владельцем.
...
**Last updated:** 2026-08-18 (применены 4 решения владельца: sitemap без /compare, /faq, /install; гарантия унифицирована на 5 лет; kreplenie.php — 5 официальных способов крепления + блок совместимых НФС класса К0; бэклог P1 пополнен пп. 13-14)
