<section class="objects-section">
    ...
    <div class="objects-grid">
        ...
        <a href="/projects" class="object-card">
            <img src="/images-convert/blocks/objects/object_residential.png" alt="" class="object-image">
        ...
        <a href="/projects" class="object-card">
            <img src="/images-convert/blocks/objects/object_admin.png" alt="" class="object-image">
            <div class="object-info">
        ...
        <a href="/projects" class="object-card">
            <img src="/images-convert/blocks/objects/object_commercial.png" alt="" class="object-image">
            <div class="object-info">
        ...
        <a href="/projects" class="object-card">
            <img src="/images-convert/blocks/objects/object_healthcare.jpg" alt="" class="object-image">
            <div class="object-info">
        ...
        <a href="/projects" class="object-card">
            <img src="/images-convert/blocks/objects/object_education.jpg" alt="" class="object-image">
            <div class="object-info">
